...
import CaseStudyCoveImport from "@/imports/CaseStudyCove";
  ...
  return (
    <>
      ...
      <FrameWrapper frameH={FRAME_H}>
        {/*
         * CaseStudyCoveImport renders the entire Figma frame unchanged:
         ...
         *  - background wave SVG, all illustrations, mockups intact
         */}
        <CaseStudyCoveImport />
      </FrameWrapper>
    </>
