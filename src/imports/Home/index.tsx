import svgPaths from "./svg-6xzm3rm8tn";
...
function Frame18() {
  return (
    <div className="content-stretch cursor-pointer flex gap-[20px] items-center justify-end relative shrink-0">
      <button className="content-stretch flex items-center justify-center overflow-clip relative shrink-0" data-name="Text-btn">
        <p className="[word-break:break-word] font-['Momo_Trust_Sans:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#543976] text-[18px] text-left whitespace-nowrap">Projects</p>
      </button>
      <button className="content-stretch flex items-center justify-center overflow-clip relative shrink-0" data-name="Text-btn">
...
function DesignProductsWithEmpathyStrategyAndTechnicalUnderstanding() {
  return (
    <div className="absolute bg-[#fff3ff] h-[768px] left-0 overflow-clip top-0 w-[1024px]" data-name="Design products with empathy, strategy, and technical understanding">
      <div className="absolute h-[698px] left-[64px] top-[70px] w-[960.25px]">
        <div className="absolute inset-[-0.57%_0_0_-0.41%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 964.332 702.358">
            <path d={svgPaths.p10151d00} id="Vector 369" stroke="url(#paint0_linear_1_403)" strokeWidth="8" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_403" x1="3.98386" x2="964.234" y1="352.999" y2="352.999">
      ...
      <button className="absolute bg-gradient-to-r content-stretch cursor-pointer drop-shadow-[0px_0px_2px_rgba(0,0,0,0.04),0px_4px_4px_rgba(0,0,0,0.06)] flex from-[#fad89e] gap-[10px] items-center justify-center left-[455px] px-[20px] py-[10px] rounded-[40px] to-[#f29bfd] top-[622px]" data-name="Button">
      ...
      <div className="absolute bg-gradient-to-r content-stretch drop-shadow-[0px_0px_2px_rgba(0,0,0,0.04),0px_4px_4px_rgba(0,0,0,0.06)] flex from-[#fad89e] gap-[10px] items-center justify-center left-[788px] px-[20px] py-[10px] rounded-[40px] to-[#f29bfd] top-[23px]" data-name="Button">
...
function MobileMockup() {
  return (
    <div className="absolute h-[398px] left-[12px] top-[83px] w-[194px]" data-name="Mobile mockup">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgMobileMockup} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgMobileMockup1} />
      </div>
...
function Card() {
  return (
    <div className="absolute backdrop-blur-[15px] bg-[rgba(229,217,230,0.24)] border-2 border-[#fad89e] border-solid h-[588px] left-[60px] overflow-clip rounded-[40px] top-[180px] w-[904px]" data-name="Card">
        ...
        <div className="h-[135px] relative shrink-0 w-full">
          <div className="absolute inset-[-38.52%_-35.37%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 251 239">
              <g filter="url(#filter0_f_1_389)" id="Ellipse 15">
                <ellipse cx="125.5" cy="119.5" fill="url(#paint0_linear_1_389)" rx="73.5" ry="67.5" />
              </g>
              <defs>
                <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="239" id="filter0_f_1_389" width="251" x="0" y="0">
                  <feFlood floodOpacity="0" result="BackgroundImageFix" />
                  <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                  <feGaussianBlur result="effect1_foregroundBlur_1_389" stdDeviation="26" />
                </filter>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_389" x1="52" x2="199" y1="119.5" y2="119.5">
      ...
      <MobileMockup />
      <div className="absolute h-[479px] left-[12px] top-[49px] w-[638px]" data-name="iPhone 15">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIPhone15} />
      </div>
      <Frame22 />
...
function CaseStudy() {
  return (
    <div className="absolute bg-[#fff3ff] h-[768px] left-0 overflow-clip top-[768px] w-[1024px]" data-name="Case study 1">
      <Card />
      <p className="-translate-x-1/2 [word-break:break-word] absolute bg-clip-text bg-gradient-to-r font-['Momo_Trust_Sans:ExtraBold',sans-serif] font-extrabold from-[#fe85ea] leading-[1.1] left-[calc(25%+256px)] text-[52px] text-[transparent] text-center to-[#5102a0] top-[84px] whitespace-nowrap">Case studies</p>
    </div>
  );
}

function MobileMockup1() {
  return (
    <div className="absolute h-[398px] left-[27px] top-[91px] w-[194px]" data-name="Mobile mockup">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgMobileMockup} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgMobileMockup1} />
      </div>
...
function Card1() {
  return (
    <div className="absolute backdrop-blur-[15px] bg-[rgba(229,217,230,0.24)] border-2 border-[#fad89e] border-solid h-[588px] left-[60px] overflow-clip rounded-[40px] top-[90px] w-[904px]" data-name="Card">
      <div className="absolute content-stretch flex flex-col gap-[170px] items-start left-[149px] top-[21px] w-[147px]" data-name="Blur-motion">
        <div className="h-[135px] relative shrink-0 w-full">
          <div className="absolute inset-[-38.52%_-35.37%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 251 239">
      ...
      <MobileMockup1 />
      <div className="absolute h-[479px] left-[11px] top-[40px] w-[683px]" data-name="Rectangle">
...
function CaseStudy1() {
  return (
    <div className="absolute bg-[#fff3ff] h-[768px] left-0 overflow-clip top-[1536px] w-[1024px]" data-name="Case study 2">
      <Card1 />
    </div>
  );
}

function MobileMockup2() {
  return (
    <div className="absolute h-[398px] left-[28px] top-[110px] w-[194px]" data-name="Mobile mockup">
      <div aria-hidden className="absolute inset-0 pointer-events-none">
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgMobileMockup} />
        <img alt="" className="absolute max-w-none object-cover size-full" src={imgMobileMockup1} />
      </div>
...
function Card2() {
  return (
    <div className="absolute backdrop-blur-[15px] bg-[rgba(229,217,230,0.24)] border-2 border-[#fad89e] border-solid h-[588px] left-[60px] overflow-clip rounded-[40px] top-0 w-[904px]" data-name="Card">
      <div className="absolute content-stretch flex flex-col gap-[170px] items-start left-[149px] top-[21px] w-[147px]" data-name="Blur-motion">
        <div className="h-[135px] relative shrink-0 w-full">
          <div className="absolute inset-[-38.52%_-35.37%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 251 239">
      ...
      <MobileMockup2 />
      <div className="absolute h-[479px] left-[11px] top-[75px] w-[683px]" data-name="iPhone 16">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIPhone16} />
      </div>
      <Frame29 />
...
function CaseStudy2() {
  return (
    <div className="absolute bg-[#fff3ff] h-[768px] left-0 overflow-clip top-[2304px] w-[1024px]" data-name="Case study 3">
      <p className="[word-break:break-word] absolute bg-clip-text bg-gradient-to-r font-['Momo_Trust_Sans:ExtraBold',sans-serif] font-extrabold from-[#fe85ea] leading-[1.1] left-[calc(37.5%+4px)] text-[52px] text-[transparent] to-[#5102a0] top-[672px] whitespace-nowrap">About me</p>
      <Card2 />
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="absolute backdrop-blur-[31px] bg-[rgba(229,217,230,0.24)] content-stretch flex flex-col items-center justify-center left-[60px] p-[20px] rounded-[20px] top-0 w-[442px]">
...
function Frame35() {
  return (
    <div className="[word-break:break-word] absolute content-stretch flex flex-col gap-[3px] items-center left-[calc(75%+20px)] text-center top-[579px] w-[176px]">
      <p className="bg-clip-text bg-gradient-to-r font-['Momo_Trust_Sans:ExtraBold',sans-serif] font-extrabold from-[#fe85ea] leading-[1.1] relative shrink-0 text-[52px] text-[transparent] to-[#5102a0] w-full">+4</p>
      <p className="font-['Momo_Trust_Sans:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#6b4a94] text-[14px] w-full">years of experience in digital product development and frontend engineering</p>
    </div>
  );
}
...
function AboutMe() {
  return (
    <div className="absolute bg-[#fff3ff] h-[768px] left-0 overflow-clip top-[3072px] w-[1024px]" data-name="About me">
      <div className="absolute flex h-[638.52px] items-center justify-center left-[calc(12.5%+75px)] top-[72px] w-[487.869px]">
            ...
            <div className="h-[135px] relative shrink-0 w-full">
              <div className="absolute inset-[-38.52%_-25.18%]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 310.495 239">
                  <g filter="url(#filter0_f_1_385)" id="Ellipse 15">
                    <ellipse cx="155.247" cy="119.5" fill="url(#paint0_linear_1_385)" rx="103.247" ry="67.5" />
                  </g>
                  <defs>
                    <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="239" id="filter0_f_1_385" width="310.495" x="0" y="0">
                      <feFlood floodOpacity="0" result="BackgroundImageFix" />
                      <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                      <feGaussianBlur result="effect1_foregroundBlur_1_385" stdDeviation="26" />
                    </filter>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_385" x1="52" x2="258.495" y1="119.5" y2="119.5">
                      <stop stopColor="#FAD89E" />
                      <stop offset="1" stopColor="#F29BFD" />
                    </linearGradient>
                  </defs>
      ...
      <div className="absolute flex h-[456.169px] items-center justify-center left-[calc(50%+46px)] top-[328px] w-[341.628px]">
      ...
      <div className="absolute h-[778px] left-[calc(12.5%+49px)] top-[-10px] w-[699px]" data-name="Profile">
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[350px] opacity-0 p-[10px] rounded-[40px] top-[712px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[294px] opacity-0 p-[10px] rounded-[40px] top-[387px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[269px] opacity-0 p-[10px] rounded-[40px] top-[452px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[348px] opacity-0 p-[10px] rounded-[40px] top-[203px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[495px] opacity-0 p-[10px] rounded-[40px] top-[396px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[482px] opacity-0 p-[10px] rounded-[40px] top-[461px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[301px] opacity-0 p-[10px] rounded-[40px] top-[647px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[421px] opacity-0 p-[10px] rounded-[40px] top-[262px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[308px] opacity-0 p-[10px] rounded-[40px] top-[322px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[263px] opacity-0 p-[10px] rounded-[40px] top-[582px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[256px] opacity-0 p-[10px] rounded-[40px] top-[517px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
        ...
        <div className="absolute bg-[#b488eb] content-stretch flex items-center justify-center left-[463px] opacity-0 p-[10px] rounded-[40px] top-[331px]" data-name="Pill">
          <div aria-hidden className="absolute border-3 border-[#fad89e] border-solid inset-[-3px] pointer-events-none rounded-[43px]" />
          <p className="[word-break:break-word] font-['Momo_Trust_Sans:Medium',sans-serif] font-medium leading-[1.5] relative shrink-0 text-[#fff3ff] text-[14px] whitespace-nowrap">Prototyping</p>
        </div>
      ...
      <div className="absolute inset-[-2.08%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 50 50">
          <g id="Frame 70">
            ...
            <rect height="48" rx="24" stroke="url(#paint0_linear_1_378)" strokeDasharray="7 7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" width="48" x="1" y="1" />
            <circle cx="25" cy="25" fill="url(#paint1_linear_1_378)" id="Ellipse 3" r="18" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_378" x1="1" x2="49" y1="25" y2="25">
              <stop stopColor="#FCBFD5" />
              <stop offset="1" stopColor="#8D75FA" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_378" x1="7" x2="43" y1="25" y2="25">
              <stop stopColor="#FCBFD5" />
              <stop offset="1" stopColor="#8D75FA" />
            </linearGradient>
          </defs>
          ...
          <div className="h-0 relative w-[685px]">
            <div className="absolute inset-[-3px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 685 3">
                <line id="Line 4" stroke="url(#paint0_linear_1_381)" strokeDasharray="6 6" strokeWidth="3" x2="685" y1="1.5" y2="1.5" />
                <defs>
                  <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_381" x1="0" x2="685" y1="3.5" y2="3.5">
...
function Frame() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-[104px] top-[30px] w-[840px]">
      <Frame1 />
      <Frame6 />
      <Frame8 />
    </div>
...
function AboutMe1() {
  return (
    <div className="absolute bg-[#fff3ff] h-[768px] left-0 overflow-clip top-[3840px] w-[1024px]" data-name="About me">
      <Frame />
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="[word-break:break-word] absolute bg-[#c79aff] content-stretch flex font-['Momo_Trust_Sans:Medium',sans-serif] font-medium h-[47px] items-center justify-end left-0 px-[60px] py-[6px] text-[14px] top-[721px] w-[1024px]">
...
function Frame36() {
  return (
    <div className="absolute bg-[#c79aff] content-stretch flex h-[89px] items-start justify-between left-0 px-[60px] py-[20px] top-[632px] w-[1024px]">
...
function City() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center justify-center left-[415px] px-[20px] py-[10px] rounded-[99999px] top-[40px]" data-name="City">
...
function Frame37() {
  return (
    <div className="absolute backdrop-blur-[32px] bg-[rgba(229,217,230,0.24)] h-[366px] left-[42px] overflow-clip rounded-[20px] top-[185px] w-[940px]">
      <ButtonContainer />
...
function ContactMe() {
  return (
    <div className="absolute bg-[#9b72ce] h-[768px] left-0 overflow-clip top-[4608px] w-[1024px]" data-name="Contact me">
      <div className="absolute h-[3812.5px] left-[35.27px] top-[-3111px] w-[1041.848px]">
        <div className="absolute inset-[0_-0.38%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1049.85 3815.02">
            <path d={svgPaths.p1387e250} id="Vector 371" stroke="url(#paint0_linear_1_383)" strokeWidth="8" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_383" x1="3.99989" x2="1045.85" y1="1906.63" y2="1906.63">
                <stop stopColor="#E9A8FF" />
                <stop offset="1" stopColor="#0FF5E5" />
              </linearGradient>
            </defs>
...
export default function Home() {
  return (
    <div className="relative size-full" data-name="Home">
      <DesignProductsWithEmpathyStrategyAndTechnicalUnderstanding />
      <CaseStudy />
      <CaseStudy1 />
      <CaseStudy2 />
      <AboutMe />
