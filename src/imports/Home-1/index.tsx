        ...
        <div className="flex h-[82px] w-full items-center justify-between gap-[16px] rounded-full bg-[#d7b8ff] px-[20px] py-[6px] md:w-[632px] md:rounded-[0_46px_10px_82px] md:py-[10px] md:pl-[44px] md:pr-[20px] lg:w-[932px] lg:[border-radius:0_46px_10px_150px/0_46px_10px_82px] lg:pl-[60px] lg:pr-[20px]">
          {variant === "back" ? (
            ...
            >
              ...
              <GradientText className="inline-block from-[#5102a0] to-[#fe85ea] whitespace-nowrap transition-transform duration-300">Patricia Rivera</GradientText>
            </button>
          )}
 ...
 * position (not a fixed-duration one-shot like `DrawPath`
 * above) — the stroke's dash-offset is recomputed on every scroll/resize
 * from how far the wrapping box has traveled through the viewport, so
 * scrolling back up retracts it too. Desktop only; height is measured at
 * runtime via `ResizeObserver` since the content above it reflows.
 */
